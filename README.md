...
4. Click the column headers to sort.  Server side sorting of the question and answer columns.  Sorting of distractors is not enabled. Clicking a column header also returns to page one.
